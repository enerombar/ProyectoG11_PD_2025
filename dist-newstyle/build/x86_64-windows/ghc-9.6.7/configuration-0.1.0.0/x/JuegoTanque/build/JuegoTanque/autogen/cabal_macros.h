...
/* package configuration-0.1.0.0 */
#ifndef VERSION_configuration
#define VERSION_configuration "0.1.0.0"
#endif /* VERSION_configuration */
#ifndef MIN_VERSION_configuration
#define MIN_VERSION_configuration(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_configuration */
...
#define CURRENT_COMPONENT_ID "configuration-0.1.0.0-inplace-JuegoTanque"
