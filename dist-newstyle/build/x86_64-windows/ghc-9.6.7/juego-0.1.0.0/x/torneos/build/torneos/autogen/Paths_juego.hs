...
-- at runtime using the environment variable juego_bindir.
...
-- environment variable juego_libdir.
...
-- using the environment variable juego_dynlibdir.
...
-- runtime using the environment variable juego_datadir.
...
-- using the environment variable juego_sysconfdir.
...
bindir     = "C:\\cabal\\bin"
libdir     = "C:\\cabal\\x86_64-windows-ghc-9.6.7\\juego-0.1.0.0-inplace-torneos"
dynlibdir  = "C:\\cabal\\x86_64-windows-ghc-9.6.7"
datadir    = "C:\\cabal\\x86_64-windows-ghc-9.6.7\\juego-0.1.0.0"
libexecdir = "C:\\cabal\\juego-0.1.0.0-inplace-torneos\\x86_64-windows-ghc-9.6.7\\juego-0.1.0.0"
