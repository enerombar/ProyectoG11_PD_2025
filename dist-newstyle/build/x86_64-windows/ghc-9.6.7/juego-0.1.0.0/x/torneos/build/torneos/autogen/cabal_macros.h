...
/* package juego-0.1.0.0 */
#ifndef VERSION_juego
#define VERSION_juego "0.1.0.0"
#endif /* VERSION_juego */
#ifndef MIN_VERSION_juego
#define MIN_VERSION_juego(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_juego */
...
#define CURRENT_COMPONENT_ID "juego-0.1.0.0-inplace-torneos"
